...
func (a *Account) IsOpenAICompatible() bool {
	return a != nil && (a.Platform == PlatformOpenAI || a.Platform == PlatformGrok || a.IsCNProvider() || a.IsOpenCodeGo() || a.IsHuggingFace())
}
...
func (a *Account) GetOpenAIBaseURL() string {
	if !a.IsOpenAI() && !a.IsCNProvider() && !a.IsOpenCodeGo() && !a.IsHuggingFace() {
		return ""
	}
...
func (a *Account) GetOpenAIProtocolAPIKey() string {
	...
	if a.IsMultiProtocolAPIKey() || a.IsHuggingFace() {
		if a.Type != AccountTypeAPIKey {
			return ""
		}
		return a.GetCredential("api_key")
