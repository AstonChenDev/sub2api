...
func RegisterGatewayRoutes(
	...
	isOpenAIResponsesCompatibleGatewayPlatform := func(c *gin.Context) bool {
		...
		case service.PlatformOpenAI, service.PlatformGrok,
			...
			service.PlatformHuggingFace, service.PlatformMiniMax, service.PlatformOpenCodeGo:
	...
	countTokensHandler := func(c *gin.Context) {
		switch getGroupPlatform(c) {
		case service.PlatformOpenAI, service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformHuggingFace, service.PlatformMiniMax, service.PlatformOpenCodeGo:
