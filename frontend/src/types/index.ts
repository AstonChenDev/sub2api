...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'huggingface' | 'minimax' | 'opencode_go' | 'composite'
...
export type UpstreamHTTPVersion = 'auto' | 'http1' | 'http2'
