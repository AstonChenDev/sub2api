...
const flagHuggingFace = makeSidebarFlag(FeatureFlags.huggingFace)
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/huggingface-pools', label: t('nav.huggingfacePools'), icon: GlobeIcon, featureFlag: flagHuggingFace },
